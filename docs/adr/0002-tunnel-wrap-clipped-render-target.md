...
> **Status:** superseded by [ADR-0008](0008-follow-camera-world-screen-split.md). The static clipped target is replaced by a follow camera; the seam is now handled by drawing periodic world content modulo world-width.
